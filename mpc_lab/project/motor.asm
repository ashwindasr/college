...
again:
	...
	CALL changeDir				; if the number of revolutions is 10, change direction of the motor.
skip:
...
setDirection:
	...
	JMP finish				
changeDir:
	CALL clearTimer			; Reset timer and 7-segment display to 0.
	MOV C, P2.0				
	CPL C
	MOV P2.0, C				; Complement the value of P2.0
	CLR P3.0					
	CLR P3.1					; stop motor

							; reset timer 1 (revolution count restarts when motor direction changes)
